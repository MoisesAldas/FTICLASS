  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 items-center w-full">
      ...
      <div className="relative flex-1 group max-w-md w-full">
        ...
        <Input
          placeholder="Buscar movimientos por atleta o ID…"
        ...
        />
        <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1 px-2 py-0.5 rounded-lg border border-white/10 bg-zinc-900/80 text-[11px] text-zinc-500 font-bold tracking-tight uppercase">
          <span className="opacity-70 text-[10px]">⌘</span>
          <span>F</span>
        </div>
      </div>

      <div className="flex items-center gap-2 shrink-0 w-full md:w-auto ml-auto">
        <Button
          variant="outline"
